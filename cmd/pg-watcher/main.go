...
const (
	PGLOGREPL_DEMO_CONN_STRING = "postgres://user:password@127.0.0.1:5432/mydatabase?replication=database"
	SLOT_NAME                  = "replication_slot"
	OUTPUT_PLUGIN              = "pgoutput"
	INSERT_TEMPLE              = "create table t (id int, name text);"
)
	...
	for {
		...
		case pglogrepl.XLogDataByteID:
			...
			case *pglogrepl.DeleteMessage:
				...
				log.Printf("DELETE %s.%s SET: %v", rel.Namespace, rel.RelationName, values)
